...
public class scaleweightholder : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    private void Start()
    {
        ...
        transform.gameObject.GetComponent<Image>().sprite = scales.sprite;
